...
from .serializers import UserSerializer, CategorySerializer, ManagerListSerializer, MenuItemSerializer, CartSerializer, CartAddSerializer, CartRemoveSerializer,SingleOrderSerializer, OrderSerializer, OrderInsertSerializer
from django.http import HttpResponse, HttpResponseBadRequest
from .forms import BookingForm
from .throttles import IsManager, IsDeliveryCrew
...
class BookingViewSet(viewsets.ModelViewSet):
    """
    ViewSet para manejar las reservas (Bookings)
    """
